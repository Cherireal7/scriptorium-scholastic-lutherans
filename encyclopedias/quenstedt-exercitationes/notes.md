...
- **2026-08-30 · Tranche 1 Part B + Tranche 2 combined — Cap. I COMPLETE** (this revision). All remaining theses IV–XXXIX of Sectio I Didactica translated (archetypa in the Trinity + in Christ *θεάνθρωπος*, theology of Angels + Adam pre-lapsum + viatores post-lapsum, mediate revelation Catechetica vs. Acroamatica, six species of Acroamatic Theology: Exegetic, Didactic, Polemic, Homiletic, Casual, Historical, plus Theologia Patriae, the essential/accidental distinction, the causal analysis — efficient/moving/middle/ministerial/formal/material/subject/end). Full Sectio II Polemica translated — three Quaestiones: Q.I *An detur Theologia?* (with antithesis of Atheists / Pagans / Libertines = Schwenckfeldians / Enthusiasts / Paracelsists / Weigelians / David Georg / Henr. Nicolai; five-argument confirmation; three fontes solutionum); Q.II *An Theologia revelata in Ecclesia sit necessaria?* (five distinctions in the exposition, four-argument confirmation ex Scriptura + ex ratione principii + ex ratione finis + ex impotentia Theologiae naturalis, two fontes solutionum on Jer. 31:34 and 1 John 2:27); Q.III *An Theologia sit habitus θεόσδοτος practicus?* — the polemic climax of Cap. I, with 15 distinctions in the exposition, four-position antithesis (Aegidius/Argentina = habitus affectivus, Marsilius/Gandavensis = pure theoretic, Thomas/Herveus/Capreolus/Cajetan/Bonaventure/Richard = mixed habit in two sub-differences, Ramus/Pareus/Sohnius/Wendelinus/Polanus = doctrina as genus + Calixt/Hornejus/Musaeus = acquired habit + Calixt/Hornejus on praxis-of-good-works), seven-argument confirmation (from end, general object, special object, means, proper formal act, analytic process, and authority), 17 fontes solutionum culminating in the citation to Meisner's *Philosophia Sobria*, and the closing bibliography of authors on Theology in general (10 Lutheran doctors, 1 Papist, 5 Calvinists). Contents section revised with the full Cap. I structure; empty Ch. II–IV stubs removed (per scope decision — *Exercitationes* = Cap. I alone). No build yet (build budget preserved for Tranche 3 volume-final polish).
