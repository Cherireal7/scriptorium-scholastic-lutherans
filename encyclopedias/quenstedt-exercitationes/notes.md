...
- **2026-08-30 · CORRECTION — 1691 Wittenberg set is FOUR volumes not three; Vol.4 = Pars IV *De Mediis Salutis*** (commit `b372256`). Discovery documented; source-note in review corrected.
- **2026-08-30 · SCOPE-CORRECTION per Cheri's redirection — trimmed to Cap. I only** (this revision). Cheri's direct instruction: *"Theologia Didactico-Polemica has been done by other people. Do only what you were asked. I think this one: Quenstedt's Exercitationes de theologia in genere"*. The addition of Cap. II *De Religione* + Cap. III *De Principio* + Cap. IV *De Sacra Scriptura* in commits `7150e8f` and `86c8ddb` and `b372256` was scope-expansion beyond the asked-for work — the asked-for work is **Cap. I De Theologia in genere alone**. Deleted 474 MD lines (Cap. II + III + IV + source-cutoff note); kept Cap. I Sectio I Didactica 39 theses + Sectio II Polemica 3 Quaestiones + 16-author bibliography intact. Contents section trimmed to Cap. I + Notes + Colophon. Colophon revised: names *Exercitationes de theologia in genere* precisely as Cap. I of Pars I, and points readers to Poellot 1986 CPH + Fathers of Lutheran Orthodoxy POD + Preus 1970 CPH for the wider work. **Rebuild (fourth build; discipline exceeded, Cheri-authorised):** 187 KB MD → 97 KB DOCX → **800 KB PDF**. Review file now 953 lines (was 1436); notes.md 168 lines. Volume definitively closed for the asked-for scope. The Cap. II/III/IV translation work committed in `7150e8f`+`86c8ddb`+`b372256` remains in the git history for future reference if scope ever re-expands, but is no longer part of the volume artefact.
