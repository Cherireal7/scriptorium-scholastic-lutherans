...
- **2026-08-30 · Vol.1 source-cutoff verified + Cap. IV Q.VI-VII enriched + Colophon + FINAL BUILD** (this revision). **Source-hunt for Cap. IV continuation:** attempted Vol.2 `bsb11205337` — turns out to be **Pars Secunda** (Anthropology, opening with *De Imagine Dei in Primo Homine*), NOT the continuation of Cap. IV of Pars I. Verified Vol.3 `bsb11205338` — turns out to be **Pars III** (starts with fresh title page + dedicatory epistle, then Predestination + Christology). Conclusion: **the 1691 Wittenberg 2nd edition compressed Pars I into a single 89-folio-page Vol.1** that stops mid-Krinomenon of Q.VIII on Church-and-Scripture (canvas 107 last words: *"Non est quaestio I. de Ecclesia primitiva... II. non, an Ecclesia sit medium praeclarum & efficax cognoscendae Scripturae, sed an..."*). The fuller Cap. IV treatment (Church-and-Scripture, Scripture-and-Tradition, Analogy of Faith, Use, Lay-Reading) belongs to the expanded 1685 and 1715 editions, which have not been sighted in a form serving reliable OCR. **Cap. IV Q.VI (Style, contra Erasmus's barbarism-charge) and Q.VII (Authority, contra Papist derivation-from-Church, contra Weigelian internal-only, contra Socinian reason)** enriched with full 4-argument confirmation apparatus + Salmasius Comm. de lingva Helleniſt. p. 260 + Chrysostom's Apostles' ἀπαιδευσία reversal (2 Cor. 4:7 = power-of-God-not-of-men) + Augustine *Contra epist. Manichaei* V *"nisi... auctoritas Catholicae Ecclesiae"* properly-read = ordinary-means-of-first-encounter not superior-authority + Dorsche *Theol. Zachariana* II.I.10 *"tanta est autoritas Scripturae quanta Dei"* + full anti-Enthusiast + anti-Socinian *fontes*. **Church-and-Scripture cutoff note** written into the translation as a scholarly source-note documenting the verified cutoff and cross-referencing Quenstedt's own 1676 *Dissertatio de lectione Scripturae Sacrae laicis concedenda* (Wittenberg, with Kühn as respondens) + Calov's *Systema* Vol. I *De Verbo Dei* + Gerhard *Loci Theologici* Vol. I on Scripture as the fuller companion-treatments. **Colophon** added: naming the 1691 Wittenberg text-base + MDZ hOCR endpoint + the Gerhard-and-Calov dedication-chain honoring uncle-and-father-in-law + closing Soli Deo Gloria. **Contents** revised with the source-cutoff parenthetical + Colophon entry. **FINAL BUILD** via `shared/build.ps1` (second and final build in the 2-build budget) — the volume-final PDF is the definitive scholarly artefact of the translation.
