...
- **T4c** (2026-09-07 ✅): *Locus II §7 Errores adversariorum* (OCR 7436-7847, ~410 lines): rejection of Papist definitions + 4 divisions + 3-part Contritio+Confessio+Satisfactio + Satisfactio 5-grade schema (undue works + Franciscan fraternities + Roman indulgences + purgatorial fire + requiem Masses) + Christ una-et-plena-satisfactio + Analectus cross-ref + Gregory Thaumaturgus 5-fold + ~140 lines of barbarous Leonine penitential verses verbatim + English translations + Selnecker's ostensio close.
- **T4d** (2026-09-07 ✅): *Locus II §8 Confessio+Absolutio+Crux Ecclesiae* (OCR 7847-8040, ~200 lines) + *§9 De Regno Christi opening* (OCR 8041-8244, ~200 lines): 5 causes for private-confession + duplex-Confessio + Absolutio-definition + 8 causae calamitatum + 11 fontes consolationum + Christi threefold regnum framework + Persona/Subjecti/Potestas Christi + Calling-of-Gentiles 5-fold instruction + Ministerium-Verbi 8-fold efficacy + servi (Constantine/Theodosius/Electors).
- **T4e** (2026-09-07 ✅): *Locus II §9 De Regno Christi close* (5th Duration + Elias 6000-year + Matt 24) + *§10 De Bonis Operibus Q1-Q7* (OCR 8265-9139, ~875 lines): 11-question outline + Q1 quae opera (Ezek 20 + ἐθελοθρησκείαι rejected) + Q2 5 requisites + Q3 persona-placet + Q4 6 causae necessitatis + Melanchthon-verbatim non-utimur ad-salutem (Major-Amsdorf) + 6 promissiones causae + Q5 discrimen peccatorum (contra conscientiam vs venialia) + 3 errors in Church + Q6 De mercede+merito Bernard via-regni + Q7 3 Papist opinions rebutted (first-grace + fides-formata + de-congruo/de-condigno) with Luther-averted-eyes + Cornelius/Bede + anti-Trajan-Gregory purgatory legend.
- **T4f** (2026-09-07 ✅): *Locus II §10 De Bonis Operibus Q7b-Q11* (OCR 9139-9585, ~450 lines): 6 remaining reasons why nemo iustificatur + Q8 Legi obedire 3-grade + Q9 Pelagian 5 arguments rebutted (Rom 2 + Deut 30 + Matt 19 + Ps 7 duplex-iustitia + Gen 6 Noe Thom-Hebrew) + Prosper triad + Luther velle-esse-iustum + Q10 opera charitatis tabulated 3-part (efficiens/obiectum/finis with mystical-body + 7-fold reasons for common-Church proximity) + Isa 58 4-part true fast + 8 sentences on mercy + Q11 vocatio 6-fold fructus + duplex-vocatio (communis + personalis) + 3 ordines (Ecclesiasticus/Politicus/Oeconomicus) + 5 requisita rectè obeunda.
- **T4g** (2026-09-07 ✅): *Locus II §10 Q11 close + Household Table + De Conscientia + §11 De Libero Arbitrio + FINIS LOCI SECUNDI* (OCR 9585-10938, ~1350 lines): 3 remaining Q11 requisita (πολυπραγμοσύνη-shunning + Gloria Dei tendere + humilitas-patientia) + 4 in-species causae + 12-order Household Table (Bishops through Widows + all-in-common with sedes texts) + De Conscientia (definition + syllogismus practicus + fulcra + prodest-testimonium-tranquillitatis) + §11 De Libero Arbitrio full (3-question opener + Luther-Gen-2/13 verbatim + 5-grades action framework + passive-aptness Abraham-Luther + FC-II synergon-resolution + beggar-analogy + Grade V eventus + closing prayer + FINIS LOCI SECUNDI marker).

## Locus III De Libertate Christiana + De Praedestinatione — IN PROGRESS

- **T5-part1** (2026-09-07 ✅): *Locus III De Libertate Christiana* full (OCR 10968-11079, ~110 lines): opening + Anabaptist deviation rejected + spiritualis-manumissio definition + 4-grade framework (Gratia + Donum + a Mosaicis + a traditionibus) + John 8 vere-liberi + integra-in-resurrectione + Libertines/Anabaptistae/Monachi execration + closing prayer.
- **T5-part2** (2026-09-07 ✅): *De Praedestinatione Theses I-XXV* (OCR 11080-11340, ~260 lines): providentia-definition + Epicurean-delirium rebutted + 12 testimonies in natura + apparent-injustice objection + 6 principal causes + Aristotle-languidness + 3-grade providence framework opener (universalis with Ps 104/Matt 10/Acts 17/Col 1) + specialis with Stoic-necessity double-rebuttal + Sirach 39 πνεύματα εἰς ἐκδίκησιν + malum-culpae vs malum-poenae Augustine Raah + Turcorum-savitia looming + 6 Prophet-discourse types.

## Reserved for future audit-tranche continuation (from OCR line 11340)

- **T5-part3**: *De Praedestinatione Theses XXVI-end* (OCR 11340-12238, ~900 lines): remaining theses + FC XI predestination framework + Selnecker as co-author.
- **T6**: *Locus IV De Ecclesia + De Oratione* (OCR 12239-15254, ~3015 lines): Ecclesia doctrine + Church power + true-vs-false Church + De Oratione appendix.
- **T7**: *Locus V De Sacramentis opening + De Baptismo* (OCR 15255-17133, ~1880 lines): definition + against Papist septenary + Baptism proper.
- **T8**: *De Coena Domini* (OCR 17134-21877, ~4740 lines): the largest section — Verba exegesis + Sacramentarian/Reformed extra-Calvinisticum refutation + FC VII manducatio-oralis framework.
- **T9**: *Locus VI De Vita Hominis + De Resurrectione + Verba Piorum* (OCR 21878-23310, ~1430 lines).
- **T10**: Back matter — FINIS SECVNDÆ PARTIS + Elenchus Locorum + Index Rerum + Colophon (OCR 23311-end, ~700 lines).
- **Audit**: paragraph-by-paragraph audit via parallel Explore agents (per Pars I methodology) + endnote apparatus finalisation + PDF build.
