# Selnecker Pars I — Shareable Build
# ═══════════════════════════════════════════════════════════════════════════
...
$reviewDir = Join-Path $repoRoot "dogmatics\selnecker-institutiones-1573\review"
$mdFile = "selnecker-institutiones-1573.md"
$refDoc = Join-Path $repoRoot "shared\reference-custom.docx"

$shareableStem = "Nikolaus-Selnecker-The-Institution-of-the-Christian-Religion-Pars-I-1579-English-Scholastic-Lutherans"

Set-Location $reviewDir

# Remove any prior artifacts
Remove-Item "$shareableStem.docx", "$shareableStem.pdf", "selnecker-institutiones-1573.docx", "selnecker-institutiones-1573.pdf" -ErrorAction SilentlyContinue

Write-Host "Building shareable Selnecker Pars I..." -ForegroundColor Cyan
