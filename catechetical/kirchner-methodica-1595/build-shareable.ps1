...
# Uses a Kirchner-specific reference DOCX that has running headers (chapter
...
#   - Reference DOCX  : reference-kirchner-methodica.docx (this volume)
#
# Optional cover-page font:
#   - IM Fell English : install from https://fonts.google.com/specimen/IM+Fell+English
#     (title-page runs reference this font by name; if not installed,
#     Word/LibreOffice will substitute a default serif face silently.)
#
...
# --- Volume paths -------------------------------------------------------------
$volumeDir  = Join-Path $repoRoot 'catechetical\kirchner-methodica-1595'
$reviewDir  = Join-Path $volumeDir 'review'
$mdFile     = 'kirchner-methodica-1595.md'
$refDoc     = Join-Path $volumeDir 'reference-kirchner-methodica.docx'
...
Remove-Item "$shareableStem.docx", "$shareableStem.pdf",
            'kirchner-methodica-1595.docx', 'kirchner-methodica-1595.pdf' `
